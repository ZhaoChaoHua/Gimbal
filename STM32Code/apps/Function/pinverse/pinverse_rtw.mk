###########################################################################
## Makefile generated for MATLAB file/project 'pinverse'. 
## 
## Makefile     : pinverse_rtw.mk
## Generated on : Mon Nov 20 17:59:50 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pinverse.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pinverse.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/pinverse -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2017a/3P.instrset/cmsis.instrset/CMSIS/Include -IC:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arm_cortex_m/include -IC:/ProgramData/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/armcortexmbase/scheduler/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=pinverse -DHAVESTDIO -DUSE_RTMODEL
...
DEFINES_STANDARD = -DMODEL=pinverse -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/pinverse/pinverse_initialize.c $(START_DIR)/codegen/lib/pinverse/pinverse_terminate.c $(START_DIR)/codegen/lib/pinverse/pinverse.c $(START_DIR)/codegen/lib/pinverse/svd.c $(START_DIR)/codegen/lib/pinverse/xnrm2.c $(START_DIR)/codegen/lib/pinverse/xscal.c $(START_DIR)/codegen/lib/pinverse/xdotc.c $(START_DIR)/codegen/lib/pinverse/xaxpy.c $(START_DIR)/codegen/lib/pinverse/xrotg.c $(START_DIR)/codegen/lib/pinverse/xrot.c $(START_DIR)/codegen/lib/pinverse/xswap.c $(START_DIR)/codegen/lib/pinverse/rt_nonfinite.c $(START_DIR)/codegen/lib/pinverse/rtGetNaN.c $(START_DIR)/codegen/lib/pinverse/rtGetInf.c
...
OBJS = pinverse_initialize.o pinverse_terminate.o pinverse.o svd.o xnrm2.o xscal.o xdotc.o xaxpy.o xrotg.o xrot.o xswap.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/pinverse/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/pinverse/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/pinverse/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/pinverse/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/pinverse/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
