...
#define MAVLINK_RX_STX 1
#define MAVLINK_RX_PLTH 2
#define MAVLINK_RX_PSEQ 3
#define MAVLINK_RX_SYSID 4
#define MAVLINK_RX_COMPID 5
#define MAVLINK_RX_MSGID 6
#define MAVLINK_RX_DATA 7
#define MAVLINK_RX_CRCL 8
#define MAVLINK_RX_CRCH 9
#define MAVLINK_RX_STOP 0
...
#define MAVLINK_MSG_ID_GIMBAL_DRONE_DATA_LEN  48
...
enum Mavlink_data_type_t
{
	...
	MAVLINK_DRONE_DATA_TYPE,
	NONE,
};



class Mavlink : public SerialManager
{
	public:
		Mavlink_msg_t      mavlink_msg_rx;
    bool ready_to_decode;
	  Mavlink(const char *rw_name, QRingBuffer &ring);
		QRingBuffer        &ringbuf;
	  ...
	  uint8_t drone_data_decode(const Mavlink_msg_t* msg, Vector3f* mag, Vector3f* emag, Vector3f* bmag, Vector3f* vel);
	...
	private:
		uint8_t _mavlink_rx_sta;
		uint8_t _mavlink_rx_data_num;
	  uint32_t _overdrop;
	  ...
	  bool mavlink_crc_check(Mavlink_msg_t* msg, uint8_t crc_extra);
