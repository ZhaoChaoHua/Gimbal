#ifndef __STM32_I2C2_H
#define __STM32_I2C2_H
#include "stm32f4xx.h"
/*====================================================================================================*/
/*
欢迎使用匿名科创STM32 IIC库  
...
//此函数必须放入stm32F4xx_it.c中的I2C2_EV_IRQHandler函数内
void ANO_TC_I2C2_ER_IRQ( void );
//此函数必须放入stm32F4xx_it.c中的I2C2_ER_IRQHandler函数内

void ANO_TC_I2C2_ReadFinish_Callback(uint8_t DevAddr,uint8_t RegAddr, uint8_t ReadNum, uint8_t *ReadTemp);
//此函数为读取操作完成后的回调函数,此函数应尽量短小,避免耗时操作
void ANO_TC_I2C2_WriteFinish_Callback(uint8_t DevAddr, uint8_t RegAddr, uint8_t WriteNum, uint8_t * WriteTemp);
