...
#define UART6_GPIO_TX       PC6
#define UART6_GPIO_RX       PC7
...
#ifdef RT_USING_UART6
    Set_pinMode(UART6_GPIO_RX,TRANS_PIN_MODE);
    Set_pinMode(UART6_GPIO_TX,TRANS_PIN_MODE);
#endif /* RT_USING_UART6 */
...
//#endif /* RT_USING_UART2 */
    ...
    serial3.config = config;
		//serial3.config.baud_rate = BAUD_RATE_230400;
